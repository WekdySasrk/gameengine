...
import { GameObject, getAllComponentDefinationNames, getBehaviourClassByName, getGameObjectById } from "../../engine";
...
export class EditorSystem extends System {
    ...
    drawPhysicsDebug() {
        ...
        this.context.save();
        const viewportMatrix = this.gameEngine.editorGameObject.getBehaviour(Camera).calculateViewportMatrix();
    ...
    drawPlayerCamera() {
        ...
        if (cameraGameObject) {
            ...
            context.beginPath();
            context.rect(-playerCamera.viewportWidth / 2, -playerCamera.viewportHeight / 2, playerCamera.viewportWidth, playerCamera.viewportHeight)
    ...
    drawEditorBackground() {
        ...
        const context = this.context
        context.save();
        context.setTransform(viewportMatrix.a, viewportMatrix.b, viewportMatrix.c, viewportMatrix.d, viewportMatrix.tx, viewportMatrix.ty);
